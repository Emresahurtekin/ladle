<template>
  <div>
    <!-- Hero Section -->
    <div
      class="relative bg-gradient-to-r from-yellow-500 to-yellow-600 min-h-[80vh] flex items-center"
    >
      <!-- Arka plan görseli -->
      <div
      ...
      <div
        class="absolute inset-0 bg-gradient-to-b from-black/70 to-black/80"
      ></div>
      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl text-white">
          <h1
            class="text-5xl md:text-7xl font-bold mb-6 text-white drop-shadow-lg"
          >
      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
          <div class="flex flex-col items-center">
            <i class="fas fa-truck-monster text-3xl text-yellow-500 mb-4"></i>
            <h3 class="text-xl font-bold text-white mb-2">Profesyonel Ekip</h3>
            <p class="text-gray-400">
              Deneyimli operatörlerimizle kaliteli hizmet
            </p>
          </div>
          <div class="flex flex-col items-center">
          ...
          <div class="flex flex-col items-center">
            <i
              class="fas fa-hand-holding-usd text-4xl text-yellow-500 mb-4"
            ></i>
